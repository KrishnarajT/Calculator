...
class Calculator extends JFrame {
    ...
    public void createButtons() {
        ...
        resultBtn.addActionListener(e -> {
            String currentString = display.getText();
            Expression expr = new Expression(currentString);
            display.setText(String.valueOf(expr.calculate()));
        });
    }

    public static void createFonts() {
        try {
            buttonFont = Font.createFont(Font.TRUETYPE_FONT, new File("/run/media/krishnaraj/Classes/University/Second Year/First Semister/OOPJC/Programs/java_implementations/assignment_8/Calculator/src/main/resources/Calculator.ttf")).deriveFont(45f);
